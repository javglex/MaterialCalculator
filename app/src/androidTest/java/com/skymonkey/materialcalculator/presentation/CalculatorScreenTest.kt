...
import com.skymonkey.materialcalculator.MainActivity
...
class CalculatorScreenTest {
    ...
    fun enterExpression_correctResultDisplayed() {
        composeRule.onNodeWithText("1").performClick() // press the 1 button
        ...
        // our result will contain this 2.0, else calculation is wrong
